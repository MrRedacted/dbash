...
function term_colors {
  ...
  PS1="${color_green}╭─\u@\h ${color_yellow}in \w ${color_blue}\t${get_status}\n${color_green}╰${color_cyan}${DBASH_ICON}${color_normal}"
}
